...
const Header: React.FC<HeaderProps> = ({ currentPage = "home", onNavigate, isDashboard }) => {
  ...
  const roleBadge = userRole === "doctor" ? (
    <span style={{ display:"flex", alignItems:"center", gap:"0.25rem", fontSize:"0.6875rem", fontWeight:700, color:"#7c9ef5", background:"rgba(124,158,245,0.12)", padding:"0.125rem 0.5rem", borderRadius:"9999px", border:"1px solid rgba(124,158,245,0.25)", letterSpacing:"0.07em", textTransform:"uppercase", fontFamily:"'Manrope', sans-serif" }}>
      <Stethoscope size={9} /> Doctor
    </span>
  ) : userRole === "patient" ? (
    <span style={{ display:"flex", alignItems:"center", gap:"0.25rem", fontSize:"0.6875rem", fontWeight:700, color:"var(--lime)", background:"rgba(234,254,69,0.12)", padding:"0.125rem 0.5rem", borderRadius:"9999px", border:"1px solid rgba(234,254,69,0.25)", letterSpacing:"0.07em", textTransform:"uppercase", fontFamily:"'Manrope', sans-serif" }}>
